      ...
      @foreach($cursos as $curso)
        <tr>
          ...
          <td>
              ...
              <a href="{{ route('cursos.destroy', $curso->id) }}" onClick="return confirm('¿Esta seguro que desea eliminar este registro?')" class="btn btn-danger btn-sm pull-left">Eliminar</a>
          </td>
        </tr>
      @endforeach
    </tbody>
