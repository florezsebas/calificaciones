      ...
      @foreach($grados as $grado)
        <tr>
          ...
          <td>
              ...
              <a href="{{ route('grados.destroy', $grado->id) }}" onClick="return confirm('¿Está seguro que desea eliminar el grado {{ $grado->nombre }}?')"  class="btn btn-danger btn-sm pull-left">Eliminar</a></td>
          </td>
      @endforeach
        </tr>
    </tbody>
