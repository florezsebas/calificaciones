      ...
      @foreach($users as $user)    
        <tr>
          ...
          <td>
              ...
              <a href="{{ route('estudiantes.destroy', $user->id) }}" onClick="return confirm('¿Esta seguro que desea eliminar este registro?')" class="btn btn-danger btn-sm pull-left">Eliminar</a></td>
          </td>
      @endforeach    
        </tr>
    </tbody>
