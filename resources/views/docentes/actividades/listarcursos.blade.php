...
<br>
<a href="{{ route('actividades.index') }}" class="btn btn-primary" style="margin-bottom:1em">Atrás</a>
<br>
    ...
    <tbody>
      @foreach($cursos as $curso)
        <tr>
          ...
          <td>
              <a href="{{ route('actividades.list', [$periodo->id,$curso->id]) }}" class="btn btn-primary btn-sm pull-left">Actividades</a>
          </td>
        </tr>
      @endforeach
    </tbody>
